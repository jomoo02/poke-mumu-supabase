    ...
    <header className="z-[100] top-0 h-14 border-b border-slate-300 sticky bg-white">
      <div className="mx-auto xl:max-w-screen-xl flex justify-between items-center h-full px-5">
        <nav className="flex h-full items-center gap-6">
          <Link
            href="/"
            className="flex items-center text-lg font-extrabold text-foreground font-sans"
          >
            {/* <div className="flex items-center text-lg font-extrabold text-slate-900 font-sans"> */}
            POKE MUMU
            {/* </div> */}
          </Link>
          <div className="text-foreground font-medium items-center px-4 ml-4 hidden sm:flex">
