import { natureTableRows, natureTableColumns } from './data';

export const getNatureTableRows = () => {
  const rows = natureTableRows.map(({ en, ...rest }) => ({
    ...rest,
...
export const getNatureTableColumns = () => natureTableColumns;
