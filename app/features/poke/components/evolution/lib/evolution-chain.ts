...
export const formatEvolutionPokeMap = (pokeList: EvolutionPoke[] | null) => {
...
export const buildEvolutionTrees = (
...
export const getEvolutionTreeDimensions = (evolutionData: EvolutionData[]) => {
