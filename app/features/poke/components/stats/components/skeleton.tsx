function Stat1() {
  ...
  return (
    <div className="flex px-1.5 gap-x-1 md:gap-x-3 items-center h-8">
      <div className="flex justify-end w-[4.375rem] md:w-24">
        <div className="w-1/2 bg-neutral-200 h-4 rounded-md" />
      </div>
      <div className="flex-1 flex items-center gap-x-1 md:gap-x-3">
        <div className="min-w-9 max-w-9 flex justify-center">
          <div className="bg-neutral-200 rounded-md h-4 w-6.5 md:w-8" />
        </div>
