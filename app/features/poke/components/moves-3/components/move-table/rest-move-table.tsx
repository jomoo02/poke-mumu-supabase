...
interface RestMoveTableProps {
  method: string;
  moves: Move[];
  versionGroup: string;
}

export default function RestMoveTable({
  method,
  moves,
  versionGroup,
}: RestMoveTableProps) {
          ...
          <div className="border border-gray-200 rounded-md overflow-auto">
            ...
            >
              <TableHeader>
                <TableHeaderCell
                  headerKey="name"
                  className="min-w-40 w-40 md:min-w-[14.5rem] md:w-[14.5rem] px-1 h-9.5 text-slate-700 font-medium text-[15px]"
                  sortAble
                >
                  기술
                </TableHeaderCell>
                ...
                <TableHeaderCell
                  headerKey="power"
                  className="min-w-24 w-24 h-9.5 px-1 text-slate-700 font-medium text-[15px]"
                  sortAble
                >
                  위력
                </TableHeaderCell>
                ...
                <TableHeaderCell
                  headerKey="pp"
                  className="min-w-20 w-20 h-9.5 px-1 text-slate-700 font-medium text-[15px] rounded-tr-md"
                  sortAble
                >
                  PP
                </TableHeaderCell>
