...
export default function PokedexInformationV2({
  pokedexData,
  sprite,
  ...
  return (
    <div>
      ...
      <div className="grid w-full gap-4">
        ...
        <div
          className={cn(
            'flex justify-center w-full px-4 gap-6 relative',
            types.length === 1 &&
              "after:content-[''] after:w-32 after:h-full after:inline-block after:invisible",
          )}
        >
          {types.map((type) => (
            <PokeTypeBadge key={type} type={type} width="w-32" />
          ))}
        </div>

        <div className="flex flex-col gap-4 justify-between">
          <div className="mt-4">
            <div className="grid grid-cols-3 w-full h-full divide-border">
